...
This image will be built nightly any time there are updates to the steam app, so you don’t have to update anything inside a container. I tried to build the image as “best-practice” as possible and to document everything for you.
